 ...
 *This program demostrates the initialization and use of dynamic arrays
 *pc12.cpp
 *Donald Wiley
 *created 02/19/2014
 *modified 02/19/2014
...
int sum (int* theArray, unsigned int arraySize)
{
    ...
    if (theArray == NULL)
        ...
        {
        for (unsigned int cnt =0; cnt < arraySize; cnt++)
            sumOfArray += theArray [cnt];
...
int max (int* theArray, unsigned int arraySize)
{
    ...
    if (theArray == NULL)
        ...
        {
                maxValOfArray = theArray[0];
                for (unsigned int cnt =0; cnt < arraySize; cnt++)
                    if (theArray [cnt] > maxValOfArray)
                        maxValOfArray = theArray [cnt];
...
int min (int* theArray, unsigned int arraySize)
{
    ...
    if (theArray == NULL)
        ...
        {
            minValOfArray = theArray[0];
            for (unsigned int cnt =0; cnt < arraySize; cnt++)
                if (theArray [cnt] < minValOfArray)
                    minValOfArray = theArray [cnt];
