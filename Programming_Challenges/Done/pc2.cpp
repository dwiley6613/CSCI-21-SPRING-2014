...
/*
 * function determines if one integer is a factor (evenly divisible into)
 * another integer.
...
void makeChange (int initialValue, int& quarters, int& dimes, int& nickels, int& pennies)
{
	...
	currentValue = initialValue -(quarters*25);
	dimes = currentValue/10;
	currentValue = currentValue -(dimes*10);
	nickels = currentValue/5;
	currentValue = currentValue -(nickels*5);
	pennies = currentValue;
}
